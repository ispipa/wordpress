...
class VikBookingAdminWidgetStickyNotes extends VikBookingAdminWidget
{
	...
	public function render($data = null)
	{
		...
		<div class="vbo-admin-widget-wrapper">
			...
			<div id="<?php echo $wrapper_id; ?>" class="vbo-admin-widget-sticky-notes-wrap" data-instance="<?php echo !$is_ajax ? static::$instance_counter : '-1'; ?>">
		...
		<script type="text/javascript">
			...
			jQuery(document).ready(function() {
				...
				for (var i = 0; i < stickies<?php echo $wrapper_instance; ?>.length; i++) {
					stickies<?php echo $wrapper_instance; ?>[i].addEventListener('input', vboDebounceEvent(vboWidgetStickyNoteUpdateTxt, 750));
				}
		...
		<script type="text/javascript">
			function vboWidgetStickyNoteAdd(elem) {
				...
				sticky_new.addEventListener('input', vboDebounceEvent(vboWidgetStickyNoteUpdateTxt, 750));
