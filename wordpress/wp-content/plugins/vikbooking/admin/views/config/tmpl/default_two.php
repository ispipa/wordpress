		...
		<div class="vbo-params-wrap">
			...
			<div class="vbo-params-container">
				<div class="vbo-param-container">
					...
					<div class="vbo-param-setting"><input type="text" name="currencyname" value="<?php echo VikBooking::getCurrencyName(); ?>" size="10"/></div>
				</div>
				<div class="vbo-param-container">
					<div class="vbo-param-label"><?php echo JText::translate('VBCONFIGTHREECURSYMB'); ?></div>
					<div class="vbo-param-setting"><input type="text" name="currencysymb" value="<?php echo VikBooking::getCurrencySymb(true); ?>" size="10"/></div>
				</div>
				<div class="vbo-param-container">
					<div class="vbo-param-label"><?php echo JText::translate('VBCONFIGTHREECURCODEPP'); ?></div>
					<div class="vbo-param-setting"><input type="text" name="currencycodepp" value="<?php echo VikBooking::getCurrencyCodePp(); ?>" size="10"/></div>
				</div>
				<div class="vbo-param-container">
				...
				<div class="vbo-param-container">
					...
					<div class="vbo-param-setting"><input type="text" name="decseparator" value="<?php echo $formatparts[1]; ?>" size="2"/></div>
				</div>
				<div class="vbo-param-container">
					<div class="vbo-param-label"><?php echo JText::translate('VBCONFIGNUMTHOSEPARATOR'); ?></div>
					<div class="vbo-param-setting"><input type="text" name="thoseparator" value="<?php echo $formatparts[2]; ?>" size="2"/></div>
				</div>
			</div>
		</div>
	</fieldset>
		...
		<div class="vbo-params-wrap">
			...
			<div class="vbo-params-container">
				...
				<div class="vbo-param-container">
					...
					<div class="vbo-param-setting"><input type="text" name="paymentname" value="<?php echo VikBooking::getPaymentName(); ?>" size="25"/></div>
				</div>
				<div class="vbo-param-container">
...
function vboPopulateDepositOverrides() {
	...
	try {
		...
		cur_ovr_cont += '<button type="button" class="btn vbo-config-btn" onclick="vboAddDepositeOverride();"><i class="icon-new"></i> '+vbo_depovr_defs.add+'</button>';
