			...
			<tr class="row">
				...
				<td style="text-align: center;">
					...
					<?php } else { ?>
						...
						<a href="index.php?option=com_vikbooking&task=shortcode.add_to_page&sc_id=<?php echo $row->id; ?>&return=<?php echo $this->returnLink; ?>" class="btn btn-danger vbo-link-btn-small" onclick="return confirm('<?php echo $this->escape(JText::translate('VBO_SC_ADDTOPAGE_HELP')); ?>');">
