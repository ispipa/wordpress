			...
			<div class="vbo-trackings-table">
				<div class="vbo-trackings-table-head">
					<div class="vbo-trackings-table-head-inner">
						...
						<div class="vbo-trackings-table-head-cell center vbo-trackings-table-cell-geo">
			...
			for ($i = 0, $n = count($rows); $i < $n; $i++) {
				...
				?>
					<div class="vbo-trackings-table-body-row">
						...
						<div class="vbo-trackings-table-body-cell center vbo-trackings-table-cell-geo" id="geo-<?php echo $row['id']; ?>">
							...
							foreach ($row['infos'] as $k => $info) {
								...
								if (!empty($info['referrer'])) {
									...
									<div class="vbo-tracking-info-booking-referrer">
										...
										<span><?php VikBookingIcons::e('globe'); ?> <?php echo $info['referrer']; ?></span>
									</div>
									<?php
								}
