	...
	<div class="vbo-admin-container">
					...
					<div class="vbo-params-container">
						<div class="vbo-param-container">
							...
							<div class="vbo-param-setting">
								<input type="text" id="condtextname" name="condtextname" value="<?php echo count($this->condtext) ? $this->condtext['name'] : ''; ?>" size="30" onkeyup="vboComposeToken(this.value);" required />
							</div>
						</div>
					</div>
					<div class="vbo-params-container">
						<div class="vbo-param-container">
							...
							<div class="vbo-param-setting">
								<input type="text" id="condtexttkn" name="condtexttkn" value="<?php echo count($this->condtext) ? $this->condtext['token'] : ''; ?>" size="30" readonly />
		...
		?>
			<div class="vbo-condtext-addrule-helper">
				<button id="vbo-condtext-addrule-scnd" type="button" class="btn vbo-config-btn" onclick="vboAddNewRule();"<?php echo !count($cond_text_rules) ? ' style="display: none;"' : ''; ?>><?php VikBookingIcons::e('plus-circle'); ?> <?php echo JText::translate('VBO_CONDTEXT_ADDRULE'); ?></button>
			</div>
		</div>
...
<div class="vbo-modal-overlay-block vbo-modal-overlay-block-condtext">
	...
	<div class="vbo-modal-overlay-content vbo-modal-overlay-content-condtext">
		...
		<div class="vbo-modal-overlay-content-body vbo-modal-overlay-content-body-scroll">
			...
			<div class="vbo-modal-condtext-rule-apply">
...
<script type="text/javascript">
	...
	function vboRemoveRule(rule) {
		...
		// show warning message if no more rules
		if (!jQuery('.vbo-condtext-rule').not('.vbo-condtext-rule-ghost').length) {
