...
jQuery(function($){'."\n".'
	$.datepicker.regional["vikbooking"] = {'."\n".'
		...
		dayNames: ["'.JText::translate('VBSUNDAY').'", "'.JText::translate('VBMONDAY').'", "'.JText::translate('VBTUESDAY').'", "'.JText::translate('VBWEDNESDAY').'", "'.JText::translate('VBTHURSDAY').'", "'.JText::translate('VBFRIDAY').'", "'.JText::translate('VBSATURDAY').'"],'."\n".'
		dayNamesShort: ["'.mb_substr(JText::translate('VBSUNDAY'), 0, 3, 'UTF-8').'", "'.mb_substr(JText::translate('VBMONDAY'), 0, 3, 'UTF-8').'", "'.mb_substr(JText::translate('VBTUESDAY'), 0, 3, 'UTF-8').'", "'.mb_substr(JText::translate('VBWEDNESDAY'), 0, 3, 'UTF-8').'", "'.mb_substr(JText::translate('VBTHURSDAY'), 0, 3, 'UTF-8').'", "'.mb_substr(JText::translate('VBFRIDAY'), 0, 3, 'UTF-8').'", "'.mb_substr(JText::translate('VBSATURDAY'), 0, 3, 'UTF-8').'"],'."\n".'
		dayNamesMin: ["'.mb_substr(JText::translate('VBSUNDAY'), 0, 2, 'UTF-8').'", "'.mb_substr(JText::translate('VBMONDAY'), 0, 2, 'UTF-8').'", "'.mb_substr(JText::translate('VBTUESDAY'), 0, 2, 'UTF-8').'", "'.mb_substr(JText::translate('VBWEDNESDAY'), 0, 2, 'UTF-8').'", "'.mb_substr(JText::translate('VBTHURSDAY'), 0, 2, 'UTF-8').'", "'.mb_substr(JText::translate('VBFRIDAY'), 0, 2, 'UTF-8').'", "'.mb_substr(JText::translate('VBSATURDAY'), 0, 2, 'UTF-8').'"],'."\n".'
...
<div class="vbo-info-overlay-block">
	...
	<div class="vbo-info-overlay-content vbo-info-overlay-content-tableauxperms">
		<h3><?php echo $vbo_app->createPopover(array('title' => JText::translate('VBOPERMSOPERATORS'), 'content' => JText::translate('VBOPERMSOPERATORSSHELP'))); ?> <?php echo JText::translate('VBOPERMSOPERATORS'); ?></h3>
		<div class="vbo-tableauxperms-info-add">
			<button type="button" class="btn btn-secondary" onclick="javascript: vboAddPermission();"><i class="icon-new"></i> <?php echo JText::translate('VBOADDOPERATORPERM'); ?></button>
		</div>
